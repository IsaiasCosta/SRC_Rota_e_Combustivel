(function (app) {
    ...
    async function cadastrarLoja(event) {
        ...
        try {
            ...
            statusCadastro.textContent = lojaEmEdicao
                ? 'Atualizando loja...'
                : 'Salvando loja...';

            const resultado = lojaEmEdicao
                ? await app.services.lojas.atualizar(lojaEmEdicao, dados)
                : await app.services.lojas.cadastrar(dados);

            const foiEdicao = lojaEmEdicao != null;
            ...
            statusCadastro.textContent = foiEdicao
                ? 'Loja atualizada com sucesso.'
                : `Loja salva com sucesso. ${resultado.lojas.length} lojas disponíveis.`;
